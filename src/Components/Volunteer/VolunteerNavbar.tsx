      ...
      <nav className="relative z-10 container mx-auto px-6 py-4 bg-white shadow-lg rounded-xl">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2">
            <span className="text-gray-900 text-2xl font-extrabold">RecruitCrew</span>
          </div>

          {/* Nav Links */}
          <div className="hidden md:flex space-x-8">
            <a href="/dashboard" className="text-gray-700 hover:text-blue-500 transition duration-300">Dashboard</a>
            <a href="/events" className="text-gray-700 hover:text-blue-500 transition duration-300">Events</a>
            <a href="my-applications" className="text-gray-700 hover:text-blue-500 transition duration-300">My Applications</a>
            <a href="/profile" className="text-gray-700 hover:text-blue-500 transition duration-300">Profile</a>
          </div>
