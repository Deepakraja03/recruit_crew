      ...
      <nav className="relative z-10 container mx-auto px-6 py-4 bg-white shadow-lg rounded-xl">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2">
            <span className="text-gray-900 text-2xl font-extrabold">Organization Panel</span>
          </div>

          {/* Nav Links */}
          <div className="hidden md:flex space-x-8">
            <a href="/organization-dashboard" className="text-gray-700 hover:text-blue-500 transition duration-300">Dashboard</a>
            <a href="/organization-addEvent" className="text-gray-700 hover:text-blue-500 transition duration-300">Add Event</a>
            <a href="/organization-events" className="text-gray-700 hover:text-blue-500 transition duration-300">Events</a>
            <a href="/OrganizationReview" className="text-gray-700 hover:text-blue-500 transition duration-300">Organization Review</a>
          </div>
